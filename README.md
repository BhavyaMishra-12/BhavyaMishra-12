...
- Built using **MediaPipe + TensorFlow + OpenCV**
- Real-time gesture recognition system  
- Targeting **~90% accuracy & <200ms latency**
- Planning NLP integration for full sentence translation  

---

### 🔹 CompileIN
> Web Compiler with AI Assistance  
...
- Integrated AI for:
  ...
  - Error detection
  - Suggestions
- Real-time developer-friendly interface  
...
- Built using **ESP32, GPS, GSM**
- Features:
  - Panic button
  - Real-time location tracking
  - Emergency alerts  
- Integrated sensors, buzzer & LED feedback system  
